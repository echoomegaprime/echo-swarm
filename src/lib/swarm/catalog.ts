...
export const MODELS: Record<ModelId, ModelDef> = {
  ...
  gpt: {
    ...
    keyField: "openai",
    oauth: true,
    oauthLabel: "Codex CLI subscription",
...
export const VARIANTS: Record<ModelId, ModelVariant[]> = {
  grok: [
    ...
    { id: "grok-4.7-build-fast", label: "Grok 4.7 Build Fast (CLI)" },
  ...
  openrouter: [
    ...
    { id: "z-ai/glm-5.3-flashx", label: "GLM 5.3 FlashX" },
...
> = {
  ...
  openai: {
    ...
    placeholder: "OpenAI API key (public edition)",
    hint: "Private GPT runs through the host's signed-in Codex CLI. Subscription usage is checked by Codex; the app does not copy its login tokens or fall back to API billing.",
  },
  anthropic: {
    label: "Anthropic",
